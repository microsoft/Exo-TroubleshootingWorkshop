...
Write-Host  " - Updating Exchange 2019 URLs..."
    ...
    Set-2019WebServicesVirtualDirectory "E2K19\ews (Default Web Site)" -ExternalUrl https://$fqdnmail/ews/Exchange.asmx  -InternalUrl https://$fqdnmail/ews/Exchange.asmx -BasicAuthentication $true -MRSProxyEnabled $true
    ...
    Set-2019MapiVirtualDirectory -Identity "E2K19\mapi (Default Web Site)" -InternalUrl https://$fqdnmail/mapi -ExternalUrl https://$fqdnmail/mapi
    Set-2019OrganizationConfig -OAuth2ClientProfileEnabled $true -MapiHttpEnabled $True
